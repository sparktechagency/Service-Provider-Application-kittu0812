  ...
  return (
    <section className="w-full py-6">
      ...
      {settingsItem.map((setting, index) => (
        <div
          key={index}
          className="w-full p-4 mb-2 text-sm rounded-lg bg-[#fff0501f] hover:bg-transparent hover:border-[#fff050] border flex items-center justify-between cursor-pointer "
          ...
          <div className="w-full px-5 ">
            ...
            >
              ...
              <Form.Item className="w-full">
                <button className="w-full bg-[#fff050] text-black p-3 text-xl font-semibold rounded-md">Update Password</button>
              </Form.Item>
            </Form>
          </div>
        )}
        {modelTitle === "Forget password" && (
          <div className="w-full px-5">
            ...
            >
              ...
              <Form.Item>
                <button className="w-full bg-[#fff050] text-white p-3 text-xl font-semibold rounded-md">Send verification code</button>
              </Form.Item>
            </Form>
          </div>
        )}
        {modelTitle === "Verify Code" && (
          <div className="px-[60px] pb-[60px] bg-primary">
            <form onSubmit={handleVerifyOtp}>
              ...
              <button className="w-full bg-[#fff050] text-white p-3 text-xl font-semibold rounded-md">Verify </button>
            </form>
          </div>
        )}
        {modelTitle === "Reset Password" && (
          <div className="px-[60px] pb-[60px] bg-primary">
            ...
            >
              ...
              <Form.Item>
                <button className="w-full bg-[#fff050] text-white p-3 text-xl font-semibold rounded-md">Update password</button>
              </Form.Item>
            </Form>
          </div>
        )}
